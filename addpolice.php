...
<label>id</label>
<input name="id" type="varchar" class="form-control" width="60%" placeholder="Enter the cop id">
</div>			
<div class="form-group">
				<label>Cop Name</label>
				<input name="copname" type="text" class="form-control" width="60%" placeholder="Enter the cop name">
			</div>
			<div class="form-group">
				<label>Designation</label>
				<input name="designation" type="text" class="form-control" placeholder="Enter the cop designation">
			</div>
			<div class="form-group">
