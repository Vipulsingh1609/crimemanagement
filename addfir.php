...
<div class="form-group">
				<label>id</label>
				<input name="id" type="int" class="form-control" width="60%" placeholder="Enter the fir id">
			</div>
			...
			<div class="form-group">
				<label>Station</label>
				<input name="station" type="text" class="form-control" placeholder="Enter the station ">
			</div>
			<div class="form-group">
